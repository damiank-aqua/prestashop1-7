...
class Cz_NewProducts extends Module implements WidgetInterface
{
    ...
    public function install()
    {
        ...
        return parent::install()
			...
			&& Configuration::updateValue('CZNEW_PRODUCTS_SIDEBAR_NBR', 5)
    ...
    public function renderWidget($hookName = null, array $configuration = [])
    {
        ...
        if ($hookName == 'displayLeftColumn' || $hookName == 'displaRightColumn' || $hookName == 'displayLeftColumnProduct' ) {
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if ($hookName == 'displayLeftColumn' || $hookName == 'displayRightColumn' || $hookName == 'displayLeftColumnProduct') {
